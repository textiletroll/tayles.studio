...
export class EditMode {
  ...
  _buildIframeEditor(config) {
    ...
    srcInput.classList.add('pe-input');
    srcInput.value = content.src || '';
    srcInput.placeholder = 'https://textiletroll.github.io/arcade/shape-stitcher/';
    srcInput.addEventListener('input', () => {
      content.src = srcInput.value;
      this._rebuildSelected();
    });
  ...
  _addIframeAtCell(cell) {
    ...
    const config = {
      ...
      rowSpan,
      layer: 1,
      content: { src: 'https://textiletroll.github.io/arcade/shape-stitcher/', title: 'Shape Stitcher' },
